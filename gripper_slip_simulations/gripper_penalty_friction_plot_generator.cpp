...
int main(int argc, char* argv[]) {
    ...
    // Create a Chrono physical system - Penalty Method
	...
	//point->SetPos(ChVector<>(0.034585310861294 + 0.0127000000001501-0.004, 0, 0.0454970193817975 + 0.0693074999999639 - 0.09+0.025));
	...
	//penalty method requires additional parameters to define the interaction
	...
	file_output.open("../../scripts/penaltydata.txt");
	while (mphysicalSystem.GetChTime() < 1)
	{
